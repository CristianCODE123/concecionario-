...
if($count2 >= 1){
    ...
    $sentencia = $bd->prepare("INSERT INTO cliente(nombre,apellido,correo,direccion,password,fecha_nacimiento) VALUES (?,?,?,?,?,?);");
    $resultado = $sentencia->execute([$nombre,$apellido,$correo,$direccion,$contraseña,$fechaNacimiento]);
}
